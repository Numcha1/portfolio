...
export const ResumeQrCard = () => {
  ...
  const resumeUrl = content.siteConfig.resumeUrl;
  ...
  return (
    <div className="rounded-2xl border border-border/70 bg-surfaceAlt/70 p-5">
      ...
      <div className="mt-4 inline-flex rounded-2xl bg-white p-3 shadow-soft">
        <QRCodeSVG value={resumeUrl} size={140} />
      </div>

      <div className="mt-4">
        <Link href={resumeUrl} target="_blank" rel="noreferrer" className="btn-secondary w-full">
          Open Resume
        </Link>
      </div>
    </div>
