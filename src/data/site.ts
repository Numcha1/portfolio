...
export const ABOUT_INTRO =
  "ผมเป็นนักศึกษาสาขาวิศวกรรมคอมพิวเตอร์และเทคโนโลยี IoT ที่สนใจงานพัฒนาระบบและซอฟต์แวร์ครับ ผมถนัดงานพัฒนาเว็บไซต์ ระบบจัดการข้อมูล และงาน Backend Development ผมชอบเรียนรู้เทคโนโลยีใหม่ ๆ และนำมาประยุกต์ใช้กับงานจริง เคยทำโปรเจกต์ทั้งด้านเว็บไซต์ ฐานข้อมูล และระบบจัดการข้อมูลหลายรูปแบบ เป้าหมายของผมคือพัฒนาทักษะการเขียนโปรแกรม การออกแบบระบบ และการแก้ปัญหาอย่างต่อเนื่อง เพื่อต่อยอดสู่การทำงานด้านเทคโนโลยีและซอฟต์แวร์ในอนาคต";
